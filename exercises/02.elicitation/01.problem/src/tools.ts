...
export async function initializeTools(agent: EpicMeMCP) {
	...
	agent.server.registerTool(
		...
		async ({ id }) => {
			...
			// 🐨 If the user does not confirm, return structuredContent with success: false, a cancellation message, and the tag.
			//    - Also return a text content saying "Tag deletion cancelled".
